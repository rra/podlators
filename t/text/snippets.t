...
my @snippets = qw(
  ...
  error-stderr error-stderr-opt for guesswork-quoting guesswork-no-quoting
  late-encoding link-rt link-url margin naive name-quotes name-quotes-none
  non-latin nonbreaking-space nonbreaking-space-l nourls periods quotes-opt
